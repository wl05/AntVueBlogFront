    ...
    <div class="index" :style="detailBagStyle">
      <div class="detail-background">
        ...
        <div class="comments-container">
          <top-gitment id="comments" :options="options" v-if="options"></top-gitment>
        </div>
      </div>
    </div>
</template>
...
export default {
  ...
  data () {
    return {
      ...
      detail: {},
      options: {
        id: `/article/detail/${this.$route.params.id}`, // 评论页唯一标识符
        owner: 'antbaobao', // github用户名
        repo: 'AntBlogComments', // 用于存放评论的仓库
        oauth: {
