<template>
  <div class="articles-result">
    <div class="articles-result__container" ref="articles-list-container">
      ...
      <CustomNoData v-else-if="!articles.length" text="没有找到文章。试试其它搜索？" />
      <div v-else>
        <p class="articles-result__tip-info">{{`"${this.$route.query.s}"的搜索结果`}}</p>
